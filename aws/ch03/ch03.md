...
## Practice #02 `aws/ch03/practices/303-null-provider`
...
## example: `aws/ch03/practices/304-create-a-module`
...
## example: `aws/ch03/practices/302-github-create-org-repo`
...
## example: `aws/ch03/practices/303-null-provider`
- Base on created instance at example: `120-create-keypair`
- Configure `null provider` trigger by instance ids and apply
